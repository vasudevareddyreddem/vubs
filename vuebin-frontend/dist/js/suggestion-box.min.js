! function(t) {
    t.fn.suggestionBox = function(n) {
        ...
        function a(n) {
            b = x.val(), t.ajax({
                ...
                success: function(t) {
                    var n = !0,
                        i = J;
                    M.results && t.results && (n = JSON.stringify(M.results[J]) !== JSON.stringify(t.results[J])), w(t), m(), i > -1 && x.val() === b && !n && (J = i, e(J)), j.ajaxSuccess(t)
                },
                error: function(t) {
                    j.ajaxError(t)
                }
        ...
        function l(t, n) {
            return parseInt(t.css(n).replace("px", ""))
        }
        ...
        function g() {
            ...
            "auto" == j.menuWidth ? O.css({
                "min-width": t
            }) : "constrain" == j.menuWidth && O.css({
                width: t
            })
        }

        function p() {
            return x.width() + l(x, "border-left-width") + l(x, "border-right-width") + l(x, "padding-left") + l(x, "padding-right")
        }

        function v(n) {
            var e = '<div id="suggestion-header">' + j.heading + '</div> <ul id="suggestion-box-list">';
            return t.each(n.results, function(n, i) {
                if (!i.suggestion || !i.url) return !1;
                E = !0;
                var r = "";
                return i.attr && t.each(i.attr, function(t, n) {
                    for (var e = Object.keys(n), i = 0; i < e.length; i++) r += e[i] + '="' + n[e[i]] + '" '
                }), e += '<li><a href="' + i.url + '" ' + r + ">" + i.suggestion + "</a></li>", n === j.results - 1 ? !1 : void 0
            }), e += "</ul>"
        }
        ...
        function m() {
            ...
            q ? E ? (O.html(n), g(), h()) : j.showNoSuggestionsMessage && x.val().length > 0 ? (g(), h(), O.html('<div id="no-suggestions">' + j.noSuggestionsMessage + "</div>")) : d() : d()
        }
        ...
        function S(n) {
            var e;
            if (n = n.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"), filterPattern = j.filterPattern.replace("{INPUT}", n), !n) return {};
            if (M && M.results) {
                var i = new RegExp(filterPattern, "i");
                e = t.grep(M.results, function(t) {
                    return i.test(t.suggestion)
                })
            }
        ...
        return O.on({
            ...
            keyup: function(t) {
                t.which !== A && t.which !== I && t.which !== P && t.which !== N && (j.url && (r(), D && clearTimeout(D)), j.url && (K[j.paramName] = x.val(), D = setTimeout(function() {
                    a(j.url)
                }, j.delay)), j.filter && m())
            },
            keydown: function(t) {
                "none" !== O.css("display") && (t.which == I && (t.preventDefault(), s()), t.which == A && (t.preventDefault(), o()), t.which === N && J > -1 && (t.preventDefault(), j.enterKeyAction()), t.which == P && (t.preventDefault(), d()))
            },
            paste: function() {
                setTimeout(function() {
                    x.keyup()
